...
using Sistema.CATEGORIA.NEGOCIO;
    ...
    public partial class FCATEGORIA : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                categoria.Insertar_Categoria(descripcion);
                dataGridView1.DataSource = categoria.MostrarCategoria();
        ...
        private void FCATEGORIA_Load(object sender, EventArgs e)
        {
            ...
            categoria = new NCATEGORIA(empresa.String_Connection);
            dataGridView1.DataSource = categoria.MostrarCategoria();
