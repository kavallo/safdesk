...
using Sistema.DEPARTAMENTO.NEGOCIO;
    ...
    public partial class FDEPARTAMENTO : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string descripcion = maskedTextBox2.Text;
                string nombre = maskedTextBox4.Text;
                depa.Insertar_Departamento(descripcion, nombre);
