...
using Sistema.TIPOBIEN.NEGOCIO;

namespace Sistema.TIPOBIEN.PRESENTACION
{
    public partial class FTIPOBIEN : Form
    {

        private NTIPOBIEN tipobien;
        ...
        private void FTIPOBIEN_Load(object sender, EventArgs e)
        {
            ...
            tipobien = new NTIPOBIEN(empresa.String_Connection);
            dataGridView1.DataSource = tipobien.MostrarTipobien();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string descripcion = maskedTextBox4.Text;
                int idcategoria = int.Parse(maskedTextBox2.Text);
                tipobien.Insertar_Tipobien(descripcion, idcategoria);
                dataGridView1.DataSource = tipobien.MostrarTipobien();
